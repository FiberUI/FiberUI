                ...
                >
                    ...
                    <SelectContent>
                        <SelectGroup>
                            ...
                            <SelectItem value="banana">Banana ksk</SelectItem>
                            <SelectItem value="blueberry">
                                Blueberry BlueberryBlueberryBlueberry
                            </SelectItem>
...
//                 <div>
//                     <Switch id="sample-switch" name="ss"></Switch>
//                     <Label htmlFor="sample-switch">Hello Switch</Label>
//                 </div>
//                 <div className="w-96">
