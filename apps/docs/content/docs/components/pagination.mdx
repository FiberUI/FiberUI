---
title: Pagination
description: A powerful pagination component for navigating large datasets. Includes page buttons, navigation controls, and page size selectors with full keyboard support.
keywords:
    ["pagination", "react", "tailwind css", "accessible", "navigation", "ui"]
---
