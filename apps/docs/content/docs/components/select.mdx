---
title: Select
description: A feature-rich select dropdown component. Supports single and multiple selection, sections, custom item rendering, and fully accessible keyboard navigation.
keywords:
