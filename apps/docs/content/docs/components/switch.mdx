---
title: Switch
description: An accessible toggle switch for binary states. Supports custom labels, sizes, and colors, with smooth animations and full keyboard accessibility.
