---
title: useAudioLevel
description: A visualization hook for analyzing audio volume in real-time. Detects speaking activity and provides raw volume data, perfect for building audio meters and active speaker indicators.
keywords:
    [
        "useAudioLevel",
        "react hook",
...
```npm
npx shadcn@latest add https://r.fiberui.com/r/hooks/use-audio-level.json
```
