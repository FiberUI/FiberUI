...
description: A media control hook for muting and unmuting audio or video tracks. Toggles media availability without stopping the underlying stream, ideal for meeting controls.
