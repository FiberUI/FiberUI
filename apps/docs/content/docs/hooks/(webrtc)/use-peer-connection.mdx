...
description: The core WebRTC hook for managing peer connections, handling the complex lifecycle of SDP negotiation, ICE candidate exchange, and connection state management for robust P2P communication.
keywords:
    [
        "usePeerConnection",
        "react hook",
...
```npm
npx shadcn@latest add https://r.fiberui.com/r/hooks/use-peer-connection.json
```
