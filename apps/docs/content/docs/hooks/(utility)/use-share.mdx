---
title: useShare
description: A cross-platform utility hook for invoking the native share sheet on mobile and desktop, enabling effortless content sharing with optional fallbacks.
keywords:
    [
        "useShare",
        "react hook",
