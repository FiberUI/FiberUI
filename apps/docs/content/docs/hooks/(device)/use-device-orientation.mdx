...
description: A comprehensive hook to access the device's physical orientation and tilt angles (alpha, beta, gamma) relative to the Earth's frame of reference.
keywords:
    [
