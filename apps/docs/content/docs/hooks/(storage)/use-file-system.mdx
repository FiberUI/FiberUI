---
title: useFileSystem
description: A powerful storage hook for reading, writing, and managing files directly on the user's local file system using the modern File System Access API.
keywords:
    [
        "useFileSystem",
        "react hook",
